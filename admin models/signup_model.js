...
var signup={
    ...
    addUserinformation:function(item,callback){
        return db.query("insert into user_tbl values(?,?,?,?,?,?,?,?)",[item.user_email,item.user_password,item.user_name,item.user_mobileno,item.user_city,item.user_gender,item.user_address,item.user_type],callback);
     },
