...
var product={
    ...
    getProductById:function(product_id,callback){
            return db.query("select i.*,p.* from product_tbl p,product_image_tbl i where p.product_id=? AND i.fk_product_id=product_id",[product_id],callback);
        },
    ...
    updateProduct:function(product_id,item,filename,callback){
            return db.query("update product_tbl set product_name=?,fk_category_id=?,product_price=?,product_colour=?,product_image=?,product_weight=?,product_warranty=?,product_material=?,product_Roomtype=?,product_height=?,product_width=?,product_depth=?,product_qty=?,product_offer=? where product_id=?",[item.product_name,item.fk_category_id,item.product_price,item.product_colour,filename,item.product_weight,item.product_warranty,item.product_material,item.product_Roomtype,item.product_height,item.product_width,item.product_depth,item.product_qty,item.product_offer,product_id],callback);
        },
    updateProductWithoutImage:function(product_id,item,callback){
            return db.query("update product_tbl set product_name=?,fk_category_id=?,product_price=?,product_colour=?,product_weight=?,product_warranty=?,product_material=?,product_Roomtype=?,product_height=?,product_width=?,product_depth=?,product_qty=?,product_offer=? where product_id=?",[item.product_name,item.fk_category_id,item.product_price,item.product_colour,item.product_weight,item.product_warranty,item.product_material,item.product_Roomtype,item.product_height,item.product_width,item.product_depth,item.product_qty,item.product_offer,product_id],callback);
        },
